...
export default function showCountryInfo(data, country, type, show) {
  ...
  countryInfo.innerHTML = `
    ...
    <ul>
      <li><strong>Cases:</strong> ${getNumberWithCommas(cases)}</li>
      <li><strong>Recovered:</strong> ${getNumberWithCommas(recovered)}</li>
      <li><strong>Deaths:</strong> ${getNumberWithCommas(deaths)}</li>
